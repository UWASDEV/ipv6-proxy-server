...
```bash
#sudo su
wget https://raw.githubusercontent.com/UWASDEV/ipv6-proxy-server/master/ipv6-proxy-server.sh && chmod +x ipv6-proxy-server.sh
./ipv6-proxy-server.sh -s 64 -c 1000 -u username -p password -t http -r 59
```
